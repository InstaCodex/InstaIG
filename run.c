...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "run",
        "sources": [
            "/data/data/com.termux/files/home/run.py"
        ]
    },
    "module_name": "run"
}
...
static const char __pyx_k_MAU_NGAPAIN_BANG[] = "MAU NGAPAIN BANG";
...
typedef struct {
  ...
  #endif
  PyObject *__pyx_n_s_;
  PyObject *__pyx_kp_s_MAU_NGAPAIN_BANG;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_s_MAU_NGAPAIN_BANG);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_s_MAU_NGAPAIN_BANG);
...
#define __pyx_kp_s_MAU_NGAPAIN_BANG __pyx_mstate_global->__pyx_kp_s_MAU_NGAPAIN_BANG
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_s_MAU_NGAPAIN_BANG, __pyx_k_MAU_NGAPAIN_BANG, sizeof(__pyx_k_MAU_NGAPAIN_BANG), 0, 0, 1, 0},
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_MAU_NGAPAIN_BANG) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
